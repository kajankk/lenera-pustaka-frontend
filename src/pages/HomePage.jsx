    ...
    <div className="home-page">
      ...
      <div className="about-section" id="about">
        ...
        <div className="description-text" style={{ textAlign: 'justify' }}>
          ...
          <p style={{ marginBottom: 0 }}>Dorongan kekecewaan yang amat sangat di kalangan mahasiswa yang bangkrut, para pelajar melarat, dan orang-orang kalah—maka daripada itu—<em>Lentera Pustaka</em> didirikan sebagai perpustakaan umum dengan semen selundupan. Kami berbagi file, mengedarkan pamflet-pamflet buatan sendiri yang kami pungut dari <em>segara</em> internet. Kami menyuntingnya, sambil menyanyikan lagu-lagu rohani dan himne <em>Indonesia Raya</em>.</p>
